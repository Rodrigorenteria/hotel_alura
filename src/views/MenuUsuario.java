...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		panelMenu.setBackground(new Color(243, 226, 180));
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/icons8-calendar-color-32.png")));
		labelRegistro.setForeground(SystemColor.text);
		labelRegistro.setBounds(25, 11, 222, 34);
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/icons8-find-user-male-windows-11-color-32.png")));
	    ...
	    panelFecha.setBackground(new Color(252, 245, 231));
