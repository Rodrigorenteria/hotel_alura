...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblTitulo.setBounds(68, 61, 260, 42);
		...
		panel_1.setBackground(new Color(243, 226, 180));
		panel.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel logo = new JLabel("");
		logo.setBounds(25, 10, 104, 107);
		panel_1.add(logo);
		...
		imagenFondo.setBounds(-319, 0, 872, 645);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/imagenes/reserva.jpg")));
		...
		txtFechaEntrada.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/imagenes/icons8-calendar-color-32.png")));
		...
		txtFechaSalida.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/imagenes/icons8-calendar-color-32.png")));
		...
		txtFormaPago.setModel(new DefaultComboBoxModel(new String[] {"Selecciona el método de pago", "Tarjeta de Crédito", "Tarjeta de Débito", "Dinero en efectivo"}));
	...
	protected void calcularValor(JDateChooser fechaE, JDateChooser fechaS) {
		if(fechaE.getDate() != null && fechaS.getDate() != null) {
			...
			int dias = -1; //Se utiliza -1 para contar a aprtir del dia siguiente
			int diaria = 500;
			int valor;
