...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		btnAtras.setBackground(new Color(247, 236, 180));
		...
		txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuesped.class.getResource("/imagenes/icons8-calendar-color-32.png")));
		...
		panel.setBackground(new Color(243, 226, 180));
		contentPane.add(panel);
		panel.setLayout(null);
		JLabel logo = new JLabel("");
		logo.setBounds(363, 10, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/imagenes/Ha-100px.png")));		
		
		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(-440, 0, 971, 654);
		panel.add(imagenFondo);
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/imagenes/huespedes.jpg")));
	...
	private void guardarHuesped() {
		...
		Huespedes nuevohuesped = new Huespedes(txtNombre.getText(), txtApellido.getText(), java.sql.Date.valueOf(fechaN),txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(),Integer.valueOf(txtNreserva.getText()));
