...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		contentPane.setBackground(new Color(243, 226, 180));
		...
		txtBuscar.setBackground(new Color(243, 226, 180));
		...
		panel.addTab("Reservas", new ImageIcon(Busqueda.class.getResource("/imagenes/icons8-calendar-color-16.png")), scroll_table, null);
		...
		panel.addTab("Huéspedes", new ImageIcon(Busqueda.class.getResource("/imagenes/icons8-find-user-male-windows-11-color-16.png")), scroll_tableHuespedes, null);
		...
		header.setBackground(new Color(243, 226, 180));
		...
		btnAtras.setBackground(new Color(243, 226, 180));
		btnAtras.setBounds(0, 0, 53, 36);
		header.add(btnAtras);
		
		labelAtras = new JLabel("<");
		labelAtras.setBackground(new Color(243, 226, 180));
		...
		btnexit.setBackground(new Color(243, 226, 180));
		btnexit.setBounds(857, 0, 53, 36);
		header.add(btnexit);
		
		labelExit = new JLabel("X");
		labelExit.setBackground(new Color(243, 226, 180));
		...
		btnbuscar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(txtBuscar.getText().isEmpty()) {
			        ...
			        JOptionPane.showMessageDialog(contentPane, "Por favor, introduce un id o apellido válido");
				}else if(scroll_table.isVisible()) {
					limpiarTablaReserva();
					busquedaPorId(Integer.valueOf(txtBuscar.getText()));
				}else {
					limpiarTablaHuespedes();
					busquedaPorApellido(txtBuscar.getText());
				}
			}
		});
	...
	private void modificarHuespedes() {
        ...
        Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    var filasModificadas = this.huespedesController.modificar(id, nombre, apellido, fechaNacimiento, nacionalidad, telefono, idReserva);
	...
	private void eliminar(JTable tabla) {
        Integer id = Integer.valueOf(tabla.getValueAt(tabla.getSelectedRow(), 0).toString());

        int filasModificadas = 0;
        if (tabla == tbReservas) {
            filasModificadas = this.reservasController.eliminar(id);
        } else if (tabla == tbHuespedes) {
            filasModificadas = this.huespedesController.eliminar(id);
        }
	...
	private void busquedaPorId(Integer id) {
    	var reservas = this.reservasController.listaPorId(id);
	...
	private void busquedaPorApellido(String apellido) {
    	var huespedes = this.huespedesController.listarPorApellido(apellido);
