...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/inicio.jpg")));
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Rodrigo Renteria © 2023");
		lblCopyR.setBounds(315, 11, 310, 19);
		lblCopyR.setForeground(new Color(0, 0, 0));
		...
		btnLogin.setBounds(754, 300, 83, 80);
		...
		imagenLogin.setBounds(0, 0, 80, 80);
		btnLogin.add(imagenLogin);
		imagenLogin.setHorizontalAlignment(SwingConstants.CENTER);
		imagenLogin.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/icons8-person-96.png")));
